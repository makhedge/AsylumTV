...
movie1 = ("/home/pi/Downloads/Video Of Volcanic Gas.mp4")
movie2 = ("/home/pi/Downloads/Pexels Videos 1093667.mp4")
...
while True:
	...
	if input_state1 != last_state1:
		if (player and not input_state1):
			...
			omxc = Popen(['omxplayer', '--loop','--no-osd', movie1])
			player = True
	...
	#If GPIO(18) is shorted to ground
		...
		if (player and not input_state2):
			os.system('killall omxplayer.bin')
			omxc = Popen(['omxplayer','--loop','--no-osd', movie2])
			player = True
